...
LiquidCrystal_I2C lcd(0x27, 16, 2);  // Alamat I2C LCD 20x4 bisa berbeda, sesuaikan jika diperlukan
...
#define oneWireBusPin D2  // Sesuaikan dengan pin yang digunakan pada Arduino Anda
